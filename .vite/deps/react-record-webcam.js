...
// node_modules/react-record-webcam/dist/component/Video.js
var require_Video = __commonJS({
  "node_modules/react-record-webcam/dist/component/Video.js"(exports) {
    "use strict";
    ...
    exports.Video = react_1["default"].forwardRef(function(_a, ref) {
      ...
      return react_1["default"].createElement("video", { style, className: cssNamespace + "__video", autoPlay, muted, ref, loop });
    });
  }
});

// node_modules/react-record-webcam/dist/constants.js
var require_constants = __commonJS({
  "node_modules/react-record-webcam/dist/constants.js"(exports) {
    "use strict";
    exports.__esModule = true;
...
// node_modules/react-record-webcam/dist/component/Controls.js
var require_Controls = __commonJS({
  "node_modules/react-record-webcam/dist/component/Controls.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    exports.Controls = function(props) {
      ...
      var showOpenCamera = props.status !== "OPEN" && props.status !== "RECORDING" && props.status !== "PREVIEW";
      ...
      return react_1["default"].createElement(
        ...
        react_1["default"].createElement(
          "div",
          { className: props.cssNamespace + "__controls" },
...
// node_modules/react-record-webcam/dist/mediaRecorder.js
var require_mediaRecorder = __commonJS({
  "node_modules/react-record-webcam/dist/mediaRecorder.js"(exports) {
    "use strict";
    ...
    var recordrtc_1 = require_RecordRTC();
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [2, __assign(__assign({}, recordRtc), { stream })];
          }
        });
      });
    }
...
// node_modules/react-record-webcam/dist/utils.js
var require_utils = __commonJS({
  "node_modules/react-record-webcam/dist/utils.js"(exports) {
    "use strict";
    exports.__esModule = true;
    exports.saveFile = void 0;
    exports.saveFile = function(filename, blob) {
      if (window.navigator.msSaveOrOpenBlob !== void 0) {
...
// node_modules/react-record-webcam/dist/component/index.js
var require_component = __commonJS({
  "node_modules/react-record-webcam/dist/component/index.js"(exports) {
    "use strict";
    ...
    var mediaRecorder_1 = require_mediaRecorder();
    var utils_1 = require_utils();
    var constants_1 = require_constants();
    var RecordWebcam = (
      /** @class */
      function(_super) {
        __extends(RecordWebcam2, _super);
        function RecordWebcam2(props) {
        ...
        RecordWebcam2.prototype.componentDidUpdate = function(_, prevState) {
          if (this.state.status !== prevState.status) {
            if (this.props.getStatus)
              this.props.getStatus(this.state.status);
          }
        };
        RecordWebcam2.prototype.handleError = function(error) {
          this.setState({
            status: "ERROR"
          });
          console.error({ error });
        };
        RecordWebcam2.prototype.stopStream = function() {
          var _a;
          if (this.recorder.stream.id && ((_a = this.recorder) === null || _a === void 0 ? void 0 : _a.stopRecording)) {
            this.recorder.stream.stop();
          }
        };
        RecordWebcam2.prototype.close = function() {
        ...
        RecordWebcam2.prototype.openCamera = function() {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  ...
                  return [4, mediaRecorder_1.mediaRecorder(this.options)];
                case 1:
                  ...
                  return [4, new Promise(function(resolve) {
                    return setTimeout(resolve, 1700);
                  })];
                case 2:
                  _a.sent();
                  this.setState({
        ...
        RecordWebcam2.prototype.start = function() {
          var _a, _b;
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_c) {
              switch (_c.label) {
                case 0:
                  _c.trys.push([0, 5, , 6]);
                  if (!((_a = this.recorder) === null || _a === void 0 ? void 0 : _a.startRecording))
                    return [3, 4];
                  return [4, this.recorder.startRecording()];
                case 1:
                  _c.sent();
                  this.setState({
                    status: "RECORDING"
                  });
                  if (!((_b = this.props.options) === null || _b === void 0 ? void 0 : _b.recordingLength))
                    return [3, 4];
                  length_1 = this.props.options.recordingLength * 1e3;
                  return [4, new Promise(function(resolve) {
                    return setTimeout(resolve, length_1);
                  })];
                case 2:
                  _c.sent();
                  return [4, this.stop()];
        ...
        RecordWebcam2.prototype.stop = function() {
          var _a, _b;
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_c) {
              switch (_c.label) {
                case 0:
                  _c.trys.push([0, 4, , 5]);
                  if (!(((_a = this.recorder) === null || _a === void 0 ? void 0 : _a.stopRecording) && ((_b = this.recorder) === null || _b === void 0 ? void 0 : _b.getBlob)))
                    return [3, 3];
                  return [4, this.recorder.stopRecording()];
                case 1:
                  _c.sent();
                  return [4, this.recorder.getBlob()];
                case 2:
                  blob = _c.sent();
        ...
        RecordWebcam2.prototype.retake = function() {
          return __awaiter(this, void 0, void 0, function() {
            var error_4;
            return __generator(this, function(_a) {
              switch (_a.label) {
        ...
        RecordWebcam2.prototype.download = function() {
          var _a, _b, _c;
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_d) {
              switch (_d.label) {
                case 0:
                  _d.trys.push([0, 3, , 4]);
                  if (!((_a = this.recorder) === null || _a === void 0 ? void 0 : _a.getBlob))
                    return [3, 2];
                  return [4, this.recorder.getBlob()];
                case 1:
                  blob = _d.sent();
                  fileTypeFromMimeType = ((_c = (_b = this.recorderOptions.mimeType) === null || _b === void 0 ? void 0 : _b.split("video/")[1]) === null || _c === void 0 ? void 0 : _c.split(";")[0]) || "mp4";
        ...
        RecordWebcam2.prototype.getRecording = function() {
          var _a;
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_b) {
              try {
                if ((_a = this.recorder) === null || _a === void 0 ? void 0 : _a.getBlob) {
                  return [2, this.recorder.getBlob()];
                }
        ...
        RecordWebcam2.prototype.render = function() {
          var _a, _b;
          return react_1["default"].createElement(
            react_1["default"].Fragment,
            null,
            ...
            react_1["default"].createElement(
              "div",
              { className: this.props.cssNamespace + "__wrapper" },
              (_b = (_a = this.props) === null || _a === void 0 ? void 0 : _a.render) === null || _b === void 0 ? void 0 : _b.call(_a, {
              ...
              react_1["default"].createElement(Video_1.Video, { cssNamespace: this.props.cssNamespace, style: {
                display: this.state.status !== "CLOSED" && (this.state.status === "OPEN" || this.state.status === "RECORDING") ? "block" : "none"
              }, autoPlay: true, muted: true, loop: true, ref: this.webcamRef }),
              react_1["default"].createElement(Video_1.Video, { cssNamespace: this.props.cssNamespace, style: {
                display: this.state.status !== "CLOSED" && this.state.status === "PREVIEW" ? "block" : "none"
              }, autoPlay: true, muted: true, loop: true, ref: this.previewRef })
            )
          );
        };
        RecordWebcam2.defaultProps = {
          cssNamespace: constants_1.NAMESPACES.CSS
        };
        return RecordWebcam2;
...
// node_modules/react-record-webcam/dist/hook/index.js
var require_hook = __commonJS({
  "node_modules/react-record-webcam/dist/hook/index.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
        ...
        return __awaiter(_this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                _a2.trys.push([0, 3, , 4]);
                return [4, mediaRecorder_1.mediaRecorder(recorderOptions)];
              case 1:
                recorderInit = _a2.sent();
        ...
        return __awaiter(_this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                _a2.trys.push([0, 6, , 7]);
                if (!(recorder === null || recorder === void 0 ? void 0 : recorder.startRecording))
                  return [3, 5];
                return [4, recorder.startRecording()];
              case 1:
                _a2.sent();
                setStatus("RECORDING");
                if (!(recorderOptions === null || recorderOptions === void 0 ? void 0 : recorderOptions.recordingLength))
                  return [3, 4];
                length_1 = recorderOptions.recordingLength * 1e3;
                return [4, new Promise(function(resolve) {
                  return setTimeout(resolve, length_1);
                })];
              case 2:
        ...
        return __awaiter(_this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                _a2.trys.push([0, 4, , 5]);
                if (!((recorder === null || recorder === void 0 ? void 0 : recorder.stopRecording) && (recorder === null || recorder === void 0 ? void 0 : recorder.getBlob)))
                  return [3, 3];
                return [4, recorder.stopRecording()];
              case 1:
                _a2.sent();
                return [4, recorder.getBlob()];
              case 2:
                blob = _a2.sent();
                preview = window.URL.createObjectURL(blob);
        ...
        return __awaiter(_this, void 0, void 0, function() {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                _c.trys.push([0, 3, , 4]);
                if (!(recorder === null || recorder === void 0 ? void 0 : recorder.getBlob))
                  return [3, 2];
                return [4, recorder.getBlob()];
              case 1:
                blob = _c.sent();
                fileTypeFromMimeType = ((_b2 = (_a2 = recorderOptions.mimeType) === null || _a2 === void 0 ? void 0 : _a2.split("video/")[1]) === null || _b2 === void 0 ? void 0 : _b2.split(";")[0]) || "mp4";
...
// node_modules/react-record-webcam/dist/types.js
var require_types = __commonJS({
  "node_modules/react-record-webcam/dist/types.js"(exports) {
    "use strict";
    exports.__esModule = true;
  }
});

// node_modules/react-record-webcam/dist/index.js
var require_dist = __commonJS({
  "node_modules/react-record-webcam/dist/index.js"(exports) {
...
recordrtc/RecordRTC.js:
   ...
   *)
*/
//# sourceMappingURL=react-record-webcam.js.map
